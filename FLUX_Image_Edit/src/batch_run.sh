...
runs=(
"--source_prompt \"A low resolution image of a leopard\" --target_prompt \"A high resolution image of a leopard.\" --guidance 2 --inject 8 --ddnm_inject 3 --source_img_dir /scratch/gilbreth/lwickrem/data/HandpickedDegrads/superres/134049.jpg"
