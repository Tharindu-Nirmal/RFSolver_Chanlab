...
# runs for colorization
# runs=(
# "--source_prompt \"A black and white image of cars parked near a walkway.\" --target_prompt \"A colorful image of cars parked near a walkway. The cars are white. The walkway is grey.\" --guidance 4 --inject 10 --ddnm_inject 1 --degradation \"colorization\" --source_img_dir /scratch/gilbreth/lwickrem/data/HandpickedDegrads/colorization/107.png"
...
# "--source_prompt \"A black and white image of a leopard\" --target_prompt \"A colorful image of a leopard. The tree is brown, with green leaves. The sky in the background is blue.\" --guidance 4 --inject 10 --ddnm_inject 1 --degradation \"colorization\" --source_img_dir /scratch/gilbreth/lwickrem/data/HandpickedDegrads/colorization/134049.jpg"
# "--source_prompt \"A black and white image of a smiling girl\" --target_prompt \"A colorful image of a smiling girl. She is wearing a blue jacket. The background is dark blue.\" --guidance 4 --inject 10 --ddnm_inject 1 --degradation \"colorization\" --source_img_dir /scratch/gilbreth/lwickrem/data/HandpickedDegrads/colorization/22.png"
# "--source_prompt \"A black and white image of cars parked in a city.\" --target_prompt \"A colorful image of cars parked in a city. The buildings in the background a are white, and the sky is blue.\" --guidance 4 --inject 10 --ddnm_inject 1 --degradation \"colorization\" --source_img_dir /scratch/gilbreth/lwickrem/data/HandpickedDegrads/colorization/573.png"
# "--source_prompt \"A black and white image of cars parked near a road.\" --target_prompt \"A colorful image of cars parked near a road. The sky is blue and the trees have green leaves.\" --guidance 4 --inject 10 --ddnm_inject 1 --degradation \"colorization\" --source_img_dir /scratch/gilbreth/lwickrem/data/HandpickedDegrads/colorization/58_rain.png"
# "--source_prompt \"A black and white image of mercedes car on a city street\" --target_prompt \"A colorful image of a purple mercedes car on a city street. The buildings on the background are light yellow. \" --guidance 4 --inject 10 --ddnm_inject 1 --degradation \"colorization\" --source_img_dir /scratch/gilbreth/lwickrem/data/HandpickedDegrads/colorization/city_read_03728.jpg"
# )
