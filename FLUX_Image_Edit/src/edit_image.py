...
def main(
    ...
    while opts is not None:
        ...
        x, _ = denoise(model, **inp_target, timesteps=timesteps, y=y, z=z, degradation_type=degradation_type, width=opts.width, height=opts.height, guidance=guidance, inverse=False, info=info)
